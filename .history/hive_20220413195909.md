...
分区表改变了Hive对数据存储的组织方式。如果我们是在mydb数据库中创建的db这个表，那么对于这个表只会有一个employees目录与之对应：
"hdfs://master_server/user/hive/warehouse/mydb.db/employees"
“"Hive现在将会创建好可以反映分区结构的子目录"   .../employees/country=CA/state=AB           .../employees/country=CA/state=BC
